...
{ return set_if(this, _investing_net_investments, from(v), sdk::Fundam_cashflow); }
...
{ return set_if(this, _operating_change_liabilities, from(v), sdk::Fundam_cashflow); }

int64_t CashFlow::investingTotal() const { return to(_investing_total); }
FieldTOpt CashFlow::setInvestingTotal(int64_t v)
{ return set_if(this, _investing_total, from(v), sdk::Fundam_cashflow); }
...
{ return set_if(this, _operating_other_adjustments, from(v), sdk::Fundam_cashflow); }
...
{ return set_if(this, _financing_equity_issuance, from(v), sdk::Fundam_cashflow); }

int64_t CashFlow::investingOther() const { return to(_investing_other); }
FieldTOpt CashFlow::setInvestingOther(int64_t v)
{ return set_if(this, _investing_other, from(v), sdk::Fundam_cashflow); }
...
{ return set_if(this, _financing_dividends_paid, from(v), sdk::Fundam_cashflow); }
...
{ return set_if(this, _operating_change_inventory, from(v), sdk::Fundam_cashflow); }
...
{ return set_if(this, _financing_buyback_net, from(v), sdk::Fundam_cashflow); }

int64_t CashFlow::financingOther() const { return to(_financing_other); }
FieldTOpt CashFlow::setFinancingOther(int64_t v)
{ return set_if(this, _financing_other, from(v), sdk::Fundam_cashflow); }
...
{ return set_if(this, _operating_net_income_adjust, from(v), sdk::Fundam_cashflow); }
...
{ return set_if(this, _investing_capital_spending, from(v), sdk::Fundam_cashflow); }
...
{ return set_if(this, _operating_change_receivables, from(v), sdk::Fundam_cashflow); }

int64_t CashFlow::operatingOther() const { return to(_operating_other); }
FieldTOpt CashFlow::setOperatingOther(int64_t v)
{ return set_if(this, _operating_other, from(v), sdk::Fundam_cashflow); }
...
{ return set_if(this, _operating_noncash_other, from(v), sdk::Fundam_cashflow); }

int64_t CashFlow::freeCash() const { return to(_free_cash); }
FieldTOpt CashFlow::setFreeCash(int64_t v)
{ return set_if(this, _free_cash, from(v), sdk::Fundam_cashflow); }
