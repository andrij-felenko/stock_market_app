...
{ return  sdk::set_if(&_track, _wall_street_target_price, v, sdk::Est_wallstr_target_price, 1e-6);}
...
{ return  sdk::set_if(&_track, _eps_estimate_current_year, v, sdk::Est_eps_curr_year, 1e-6); }
...
{ return  sdk::set_if(&_track, _eps_estimate_next_year, v, sdk::Est_eps_next_year, 1e-6); }
...
{ return  sdk::set_if(&_track, _eps_estimate_current_quart, v, sdk::Est_eps_curr_quart, 1e-6); }
...
{ return  sdk::set_if(&_track, _eps_estimate_next_quart, v, sdk::Est_eps_next_quart, 1e-6); }

const QDate& sdk::Estimate::   recentQuart() const { return _recent_quart; }
FieldTOpt    sdk::Estimate::setRecentQuart(const QDate& date)
{ return     sdk::set_if(&_track, _recent_quart, date, sdk::Fundam_recent_quart); }
// ================================================================================================


// --------------------------- Analyst ------------------------------------------------------------
FieldTOpt sdk::Estimate::setAnalystConsensusRate(double rate)
{ return  sdk::set_if(&_track, _analyst.consensus_rate, rate, sdk::Analyst_rate); }

FieldTOpt sdk::Estimate::setAnalystTargetPrice(double price)
{ return  sdk::set_if(&_track, _analyst.target_price, price, sdk::Analyst_targetprice); }

FieldTOpt sdk::Estimate::setAnalystStrongBuy(uint16_t count)
{ return  sdk::set_if(&_track, _analyst.strongbuy, count, sdk::Analyst_strongbuy); }

FieldTOpt sdk::Estimate::setAnalystBuy(uint16_t count)
{ return  sdk::set_if(&_track, _analyst.buy, count, sdk::Analyst_buy); }

FieldTOpt sdk::Estimate::setAnalystHold(uint16_t count)
{ return  sdk::set_if(&_track, _analyst.hold, count, sdk::Analyst_hold); }

FieldTOpt sdk::Estimate::setAnalystSell(uint16_t count)
{ return  sdk::set_if(&_track, _analyst.sell, count, sdk::Analyst_sell); }

FieldTOpt sdk::Estimate::setAnalystStrongSell(uint16_t count)
{ return  sdk::set_if(&_track, _analyst.strongsell, count, sdk::Analyst_strongsell); }
...
namespace sdk {
    QDataStream& operator << (QDataStream& s, Wire <const Estimate> d){
        if (d.data()) s << d->_wall_street_target_price
