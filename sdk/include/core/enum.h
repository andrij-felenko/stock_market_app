...
enum class Country : uint16_t {
    ...
    SerbiaCrnaGora       = +Region::Balkans | 0b1000, // obsolete
    ...
    FaroeIslands  = +Region::BritishIsles | 0b0110,
    ...
    Liechtenstein = +Region::CentralEurope | 0b0101,
    ...
    AntiguaBarbuda    = +Region::Caribbean | 0b1101,
    Anguilla          = +Region::Caribbean | 0b1110,
    NetherlAntilles   = +Region::Caribbean | 0b1111,
    ...
    FrenchGuiana = +Region::SouthAmerica | 0b1110,
    ...
    Rossiya      = +Region::CentralAsia | 0b0110,
