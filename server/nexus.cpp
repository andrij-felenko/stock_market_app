...
sdk::Market* Nexus_t::market() const { return Nexus.market(); }
sdk::Roster* Nexus_t::roster() const { return Nexus.roster(); }

sdk::api::EndPoints* Nexus_t::network() const { return Nexus.network(); }
